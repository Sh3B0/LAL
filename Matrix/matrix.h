 ...
 * 1- Matrix Class, Will support:
 *      Addition, Subtraction, Multiplication, "Division" (Multiplication by Inverse).
 *      Inverse, Transpose, Row Reduction, Determinant, Trace, Rank.
 *      EigenValues, EigenVectors.
 *      Decompositions: LU, LDU, Cholesky, QR, SVD.
 *      Solving Ax = b Linear systems.
 *          - Gaussian Elimination.
 *          - Jacobi and Seidel Methods.
 *      Calculating Least square approximation.
 */
